    ...
    return (
      <Card className="overflow-hidden bg-ink text-white">
        <CardHeader className="border-b border-white/10">
          <p className="section-label text-white/45">Location Intelligence</p>
          <CardTitle className="text-white">Mission Control Map</CardTitle>
        </CardHeader>
          ...
          <div className="terminal-grid flex h-[360px] items-center justify-center rounded-2xl border border-white/10 bg-white/[0.03]">
            <div className="max-w-xs space-y-3 text-center">
              <p className="font-display text-2xl font-bold tracking-[-0.04em]">
                Location pending geocode
              </p>
              <p className="text-sm leading-6 text-white/65">
                The map will lock onto the shipment once coordinates are stored or resolved.
              </p>
              <p className="font-mono text-xs uppercase tracking-[0.2em] text-white/45">
                {locationName ?? "Awaiting location data"}
              </p>
            </div>
          </div>
          <p className="sr-only">
            A map preview is unavailable because this shipment does not yet have coordinates.
          </p>
        </CardContent>
      </Card>
    );
